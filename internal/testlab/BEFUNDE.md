...
Von neunzehn Befunden sind zehn behoben und einer zur Hälfte; acht stehen offen. Zwei davon können eine Kommandozeile verfälschen, vier verlieren Text im Stream oder beim Rückweg, einer ersetzt mehr als er soll, und einer betrifft die Schlüsselnamen im JSON. Behoben sind die sieben Kuren von je einer Zeile, die dieses Kapitel am 7. September vorschlug, und dazu am selben Tag die drei Lecks, die eine Entscheidung brauchten: die Zuordnung ist an das Gespräch gebunden statt an die Anfrage, das Composite schließt aus, was die Tabelle kennt, statt was wie ein Ersatzwert aussieht, und die Vorschicht der Verschmelzung gilt für jede Art statt nur für Mailadressen. Die Frist der Tabelle läuft seit derselben Kur ab der letzten Nutzung. Die Kapitel dazu sind stehen geblieben und tragen den Vermerk, womit sie behoben wurden; die offenen tragen wie zuvor ihren roten Test und einen Vorschlag, wie zu kurieren wäre. Sie sind die Arbeit, die bleibt. Jedes dieser Kapitel nennt Ursache, Fundort, Reproduktion und Vorschlag genau genug, dass eine andere Sitzung sie der Reihe nach abarbeiten kann, ohne diese hier gelesen zu haben; die Reihenfolge steht im nächsten Kapitel.
...
Ausführen mit `go test ./...`; die Suite ist grün. Die fünfundzwanzig Tests, die einen offenen Befund festhalten, überspringen sich selbst und sagen es. Wer sie fallen sehen will, setzt eine Umgebungsvariable:
